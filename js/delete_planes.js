$(document).ready(function() {
    $('.btn-delete').on('click', function() {
      ...
      $('#btnConfirmarEliminar').data('paciente-id', planId);
      $('#modalEliminar .modal-body').text('¿Estás seguro de que deseas eliminar el plan"' + PlanNombre + '"?');
    ...
    $('#btnConfirmarEliminar').on('click', function() {
      var planId = $(this).data('paciente-id');
  
      // Llamada Ajax para eliminar el registro
      $.ajax({
        url: 'ajax/eliminar_plan.php', // Reemplaza con la ruta correcta a tu script PHP
        method: 'POST',
        data: { plan_id: planId },
