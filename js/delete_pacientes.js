$(document).ready(function() {
    $('.btn-delete').on('click', function() {
      ...
      $('#btnConfirmarEliminar').data('paciente-id', pacienteId);
      $('#modalEliminar .modal-body').text('¿Estás seguro de que deseas eliminar a "' + pacienteNombre + '"?');
    ...
    $('#btnConfirmarEliminar').on('click', function() {
      ...
      $.ajax({
        url: 'ajax/eliminar_paciente.php', // Reemplaza con la ruta correcta a tu script PHP
        method: 'POST',
